...
class QSPComplianceAPITester:
    def __init__(self, base_url="https://reg-cascade.preview.emergentagent.com"):
    ...
    def login_admin_user(self):
        ...
        try:
            ...
            login_data = {
                ...
                "password": "Tulip123!"  # Updated password from review request
            }
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        # Run Hierarchical Cascade Mapping Testing (as requested in review)
        tester = QSPComplianceAPITester()
        try:
            success = tester.run_hierarchical_cascade_mapping_tests()
            return 0 if success else 1
        except KeyboardInterrupt:
